...
2. Use available references and product constraints. Search for prior art only when it resolves a concrete design question; make routine choices without adding a moodboard approval step.
